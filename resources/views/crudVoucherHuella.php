...
<body>
    <form action="" method="POST">
        <center><img src="../css//SEBAD Logo.jpg" width="300" height="300"></center>   
        <center>
        <table border='1' style="text-align: center">
            <tr>
                <td><b>Codigo de Entrada</b></td>
                <td><?php echo $vaCodVoucher.strlen($vaNom).strlen($vaApe).rand(1, 100); ?></td>
            </tr>
            <tr>
                <td><b>Rut&nbsp;</b></td>
                <td><?php echo $rut;?></td>
    ...
    <center>
    <form action="../prints_PDF/PDF_voucherBeneficiario.php" method="post">
