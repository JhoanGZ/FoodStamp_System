<?php
    include("../logic/btnLogic/btnLogic_userFeedAdmin.php");
    include("../logic/formVars/formDataCatcher.php");
?>
...
<html lang="es_la">
    <head>
        ...
        <?php include("../component/verificacionSesion.php");//Invoca el reloj;?>
    </head>
    <body>
        <center>
            <br><br>
